...
(defvar my-packages '(ac-nrepl ace-jump-mode auto-complete
  ...
  column-marker crosshairs exec-path-from-shell flycheck go-mode
  haskell-mode hl-line+ ido-ubiquitous lua-mode markdown-mode
  cider org popup rainbow-mode scss-mode smartparens smex
  solarized-theme tuareg vline yasnippet)
