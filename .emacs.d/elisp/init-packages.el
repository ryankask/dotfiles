...
(defvar my-packages
  '(ac-nrepl ace-jump-mode auto-complete browse-kill-ring clojure-mode
             col-highlight column-marker crosshairs exec-path-from-shell
             flycheck go-mode hl-line+ lua-mode markdown-mode cider org
             popup rainbow-mode scss-mode smartparens smex solarized-theme
             vline yasnippet)
